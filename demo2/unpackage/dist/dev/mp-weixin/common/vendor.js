...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/login/login": { "navigationBarTitleText": "登录" }, "pages/main/main": { "navigationBarTitleText": "首页" }, "pages/reg/reg": { "navigationBarTitleText": "注册" }, "pages/pwd/pwd": { "navigationBarTitleText": "找回密码" }, "pages/user/user": { "navigationBarTitleText": "个人中心" }, "pages/rowthRecord/babyInfo": { "navigationBarTitleText": "宝宝信息" }, "pages/rowthRecord/rowthRecord": { "navigationBarTitleText": "生长记录" }, "pages/childrenSwn/babyInformation": { "navigationBarTitleText": "宝宝信息" }, "pages/childrenSwn/addBabyInformation": { "navigationBarTitleText": "填写宝宝信息" }, "pages/interaction/interactionIndex": { "navigationBarTitleText": "咨询案例" }, "pages/expert/expertIndex": { "navigationBarTitleText": "专家介绍" }, "pages/healthEducation/healthEducation": { "navigationBarTitleText": "健康宣教" }, "pages/academicCommunication/academicCommunication": { "navigationBarTitleText": "学术交流" }, "pages/nearHospital/nearHospital": { "navigationBarTitleText": "附近医院" }, "pages/user/userBabyInfo/userBabyInfo": { "navigationBarTitleText": "宝宝信息" }, "pages/user/userBabyInfo/basicInformationOfBaby": { "navigationBarTitleText": "宝宝基本信息" }, "pages/user/userBabyInfo/setBabyInfo": { "navigationBarTitleText": "修改基本信息" }, "pages/user/myInformation/myInformation": { "navigationBarTitleText": "我的信息" }, "pages/user/myInformation/setMyInformation": { "navigationBarTitleText": "修改基本信息" }, "pages/user/myAdvice/myAdvice": { "navigationBarTitleText": "我的咨询" }, "pages/user/myAdvice/detailsOfInquiryReply": { "navigationBarTitleText": "咨询回复详情" }, "pages/user/myAdvice/lmmediatelyConsult": { "navigationBarTitleText": "立即咨询" }, "pages/user/inspectionRecords/inspectionRecords": { "navigationBarTitleText": "自查记录" }, "pages/user/feedback/feedback": { "navigationBarTitleText": "意见反馈" }, "pages/partners/partners": { "navigationBarTitleText": "合作伙伴" }, "pages/partners/partnersDetails": { "navigationBarTitleText": "介绍" }, "pages/main/mainDetails": { "navigationBarTitleText": "介绍" }, "pages/expert/expertDetails": { "navigationBarTitleText": "专家介绍" }, "pages/user/inspectionRecords/inspectionRecordsDetails": { "navigationBarTitleText": "自查记录详情" }, "pages/healthEducation/healthEducationDetails": { "navigationBarTitleText": "详情" }, "pages/healthEducation/healthEducationList": { "navigationBarTitleText": "列表" } }, "globalStyle": { "navigationBarTextStyle": "white", "navigationBarBackgroundColor": "#0faeff", "backgroundColor": "#fbf9fe" } };exports.default = _default;
